...
def migrate(cr, version):
    """
    Post-migración stock_ux 19.0.1.7.0
    ...
    2. Desactivar vistas problemáticas (other_currency + vistas rotas como 4559)
    ...
    _logger.info("=" * 70)
    _logger.info("stock_ux post-migrate 19.0.1.7.0: limpieza y reactivación")
    _logger.info("=" * 70)
    ...
    # ==================================================================
    _logger.info("2. Desactivando vistas problemáticas (other_currency + vistas rotas + document_tax_totals duplicadas)")
    cr.execute("""
        UPDATE ir_ui_view SET active = False
        WHERE id IN (3974, 4263, 4594, 4559, 4153, 4296, 3184, 3681, 5754) AND active = True
    """)
